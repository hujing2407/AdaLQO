...
class BaoRegression:
    ...
    def fit_feature_extractor(self, X, y):
        ...
        if self.__have_cache_data:
            ...
            print("num_operators =", self.__tree_transform.num_operators())
            print("expected =", self.__tree_transform.num_operators() + 3)
    ...
    # Added this method
    def get_treeconv_embeddings(self, X):
        ...
        with torch.no_grad():
            emb = self.__net.get_fixed_features(X)
